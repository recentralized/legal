...
* **Analytics:** We may use third party analytics services, such as Google Stackdriver and Google Analytics, to grow our business, improve and develop our Services, monitor and analyze use of our Services, aid our technical administration, increase the functionality and user-friendliness of our Services, and to verify that users have the authorization needed for us to process their requests.  These analytics services may collect and retain some information about you.  Google Analytics collects the IP address assigned to you on the date you use the Services, but not your name or other personally identifying information.  We do not combine the information generated through the use of Google Analytics with your Personal Information.
